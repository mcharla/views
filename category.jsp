...
<body>
	<center>
		...
		<form:form method="POST" commandName="category"
			action="/FirstSpringWebMVC/addCategory">
			<table>
				<tr>
					<td><font color="red">*</font>CategoryID: <form:input
							path="categoryId" id="categoryId" /></td>
					<td style="color: red"><form:errors path="categoryId" /></td>
				</tr>
				<tr>
					<td><font color="red">*</font>Category Name: <form:input
							path="categoryName" id="categoryName" /></td>
